...
<a href="https://lf.hippor.com/demo/dist/examples/#/extension/bpmn-elements?from=doc" target="_blank"> 去 CodeSandbox 查看示例</a>
...
完整的 BPMN 案例工具请到[示例](https://lf.hippor.com/examples/#/gallery)中体验。
